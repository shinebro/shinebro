...
const ProductDetail = () => {
    ...
    const [newReview, setNewReview] = useState({ rating: 5, text: '', name: 'User' });
                    ...
                    <div className="md:w-[40%] lg:w-[35%] p-4 border-r border-gray-200 relative">
                        <div className="sticky top-24">
                            <div className="flex flex-col-reverse md:flex-row gap-4 h-[450px]">
                                ...
                                <div className="flex md:flex-col gap-2 overflow-auto md:w-16 no-scrollbar">
                                    {productImages.map((img, i) => (
                                        <div
                                            ...
                                            className={`border p-1 cursor-pointer hover:border-blue-600 rounded-sm h-16 w-16 flex-shrink-0 ${i === currentImageIndex ? 'border-blue-600' : 'border-gray-200'}`}
                                        >
                                            <img
                                                src={img}
                                                alt={`Thumbnail ${i}`}
                                ...
                                {/* Main Image Carousel */}
                                <div className="flex-1 flex items-center justify-center border border-gray-100 relative group bg-white">
                                    ...
                                    <button
                                        onClick={prevImage}
                                        className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white p-2 rounded-full shadow-md z-10 opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                                        <ChevronRight size={24} className="rotate-180" />
                                    </button>
                                    <button
                                        onClick={nextImage}
                                        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white p-2 rounded-full shadow-md z-10 opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <input
                                        ...
                                        className="outline-none text-sm font-medium text-gray-900 placeholder-gray-400 w-40 border-b border-gray-300 focus:border-blue-500 pb-1"
                                    />
                                ...
                                <div className="text-sm">
                                    ...
                                    {isAvailable && (
                                        <div className="flex flex-wrap items-center gap-2">
                                            ...
                                            <span className="text-gray-500 line-through text-xs">₹40</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="mt-8 border border-gray-200 rounded-sm">
                            <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="shadow-md border border-gray-300 px-4 py-2 text-sm font-medium rounded-sm hover:shadow-lg transition-shadow w-full sm:w-auto"
                                >
                                    ...
                                    <form onSubmit={handleReviewSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full p-2 border border-gray-300 rounded-sm focus:ring-1 focus:ring-blue-500 outline-none"
                                                rows="3"
                                        ...
                                        <button
                                            type="submit"
                                            className="bg-blue-600 text-white px-6 py-2 rounded-sm font-medium hover:bg-blue-700 transition-colors"
                                        >
                                            Submit Review
                                        </button>
                                    </form>
